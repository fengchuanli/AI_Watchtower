...
The validator checks edition metadata, category definitions and label consistency, required item fields including evidence thresholds and claim boundaries, source ID references, and URL shape.
